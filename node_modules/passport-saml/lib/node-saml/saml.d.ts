...
import { CacheProvider as InMemoryCacheProvider } from "passport-saml/lib/node-saml/inmemory-cache-provider";
import { ParsedQs } from "qs";
import { SamlOptions } from "passport-saml/lib/node-saml/types";
import { AuthenticateOptions, AuthorizeOptions, Profile, SamlConfig } from "passport-saml/lib/passport-saml/types";
interface NameID {
    value: string | null;
    format: string | null;
}
